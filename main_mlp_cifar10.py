...
for epoch in range(num_epochs):
    ...
    ax2.plot(epochs_plotting, update_ranks_layer1, label='layer1', color=color)
    ax2.plot(epochs_plotting, update_ranks_layer2, label='layer2',linestyle='dashed' ,color=color)
    ...
    ax2.plot(epochs_plotting, update_ranks_from_init_layer1, label='layer1', color=color)
    ax2.plot(epochs_plotting, update_ranks_from_init_layer2, label='layer2', linestyle='dashed', color=color)
    ax2.tick_params(axis='y', labelcolor=color)
    ...
    ax2.plot(epochs_plotting, nfm1_rank, label='layer 1', color=color)
    ax2.plot(epochs_plotting, nfm2_rank, label='layer 2', linestyle='dashed', color=color)
    ax2.tick_params(axis='y', labelcolor=color)
...
ax2.plot(epochs_plotting, nfm1_alignment, label='layer 1', color=color)
ax2.plot(epochs_plotting, nfm2_alignment, label='layer 2', linestyle='dashed', color=color)
ax2.tick_params(axis='y', labelcolor=color)
